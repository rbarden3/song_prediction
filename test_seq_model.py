...
# def build_sequential_model(input_dim=376):
#     model = tf.keras.Sequential()
#     # model.add(Input(shape=(800,None,13)))
#     model.add(LSTM(units=13, input_shape=(None,13), activation='relu'))
#     model.add(Dropout(0.5))
...
# def build_sequential_model(input_dim=376):
#     model = tf.keras.Sequential()
#     # model.add(tf.keras.layers.Embedding(377, 169, input_length=13))
#     # model.add(Input(shape=(None, 13)))
